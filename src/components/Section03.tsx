...
const Section03 = ({ pType, pName }: TSection03Props) => {
  ...
  return (
    <>
      <section id="invitation" ref={ref} className={'relative flex min-h-dvh -translate-y-30 flex-col items-center justify-center font-Questrial text-lg'}>
        <BgBookOpening
          isOpen={isOpen}
          pName={pName}
          pType={pType}
          renderName={
            <div className="absolute top-[78px] left-0 flex w-full justify-center px-6 text-center">
              <div
                className={cn(
                  'line-clamp-2 max-w-[320px] text-center !font-DancingScript text-2xl leading-[1.1] font-600 text-red-600',
          ...
          renderOpenExtra={
            <>
              <div className="relative z-10 flex items-center justify-center rounded-full sm:absolute sm:-bottom-20 sm:-left-20 sm:-translate-x-1/2">
                <Image alt="2611" height={0} src="/images/savethedate.svg" width={200} className="z-10 bg-transparent object-cover" />
                <div className="absolute top-[33px] left-1/2 z-0 size-[180px] -translate-x-1/2 rounded-full border border-red-500/20 bg-white"></div>
              </div>
