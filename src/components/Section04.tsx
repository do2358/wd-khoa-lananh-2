  ...
  return (
    <section className="relative flex min-h-dvh items-center justify-center max-sm:flex-col max-sm:pt-20 max-sm:pb-40 sm:max-h-[1500px]">
      <div className="flex flex-col items-center justify-center max-sm:mt-20">
        ...
        <MotionEffect inView inViewOnce={false} slide={{ direction: 'left' }} className={cn('mb-3 font-DancingScript text-5xl text-red-800')}>
          Trịnh Thu Huyền
        </MotionEffect>
      ...
      {mediaAbove640 && (
        ...
        >
          <RcImage
            ...
            width={'100%'}
            className="w-full cursor-pointer rounded-full object-cover sm:min-h-[600px]!"
          />
      ...
      <div className="flex flex-col items-center justify-center max-sm:-order-1">
        ...
        <MotionEffect inView inViewOnce={false} slide={{ direction: 'right' }} className={cn('font-DancingScript text-5xl text-red-800 ')}>
          Ngô Việt Tùng
        </MotionEffect>
      </div>
